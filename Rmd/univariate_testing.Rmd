...
For categorical variables, I set all values with a frequency less than 5% to rare. V22-V23 and V33-V35 have a lot of these rare values. V22-V23 seem to be family status and V33-V35 seem to be "country of birth". If I spent more time on this project, I would probably map V33-V35 to geographic regions to recover some of the information in those variables.
